...
int main()
{
	...
	list* firstOdd = NULL; // указатели на первый и последний нечетный элемент
	list* lastOdd = NULL;
	...
	if (firstOdd == NULL) { // нечетных элементов нет
		cout << "Нечетных элементов нет" << endl;
	}
	else if (firstOdd == lastOdd) { // один нечетный элемент
